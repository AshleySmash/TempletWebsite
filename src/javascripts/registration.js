...
function validatePasswordInput() {
    ...
    if (!passwordRegex.test(password)) {
        alert("Password must be 8-20 characters long and include at least one uppercase letter, one lowercase letter, one number, and one special character. Please correct the password.");
        return false;
    }
